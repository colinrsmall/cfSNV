...
def pileup_to_rebase_frequent_variant_whole_file(input, output, indel): #, normal_bedcov_list, tumor_bedcov_list):
# input: a pileup file
...
#	normal_bedcov_list, tumor_bedcov_list = extract_coverage_in_exon(fnormal_bedcov, fnormal_flagstat, ftumor_bedcov, ftumor_flagstat)
	pileup_to_rebase_frequent_variant_whole_file(finput, foutput, findel)#, normal_bedcov_list, tumor_bedcov_list)
