...
TRIALLELE_VAF_RATIO = 0.5 # _filter
TRIALLELE_VAF = 0.02 # _filter
TRIALLELE_COUNT = 4 # _filter
...
VAF_FOR_STRONG_EVIDENCE = 0.0005
...
VARIANT_COUNT_FOR_JENK_ESTIMATION = 30 
P_VALUE_BINOMIAL_TEST_JENKS_ESTIMATE = 0.1
VARIANT_COUNT_STOP_ADDING_IN_JENK_ESTIMATION = 20
