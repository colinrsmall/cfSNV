...
def calculate_tumor_fraction_likelihood(tumor_fraction, basestring_merge, quallist_merge, maplist_merge, basestring_normal, quallist_normal, maplist_normal, variant_base):
    ...
    for i in joint_genotype_list:
        l1 = calculate_joint_genotype_tumor_fraction_loglikelihood(tumor_fraction, basestring_merge, quallist_merge, maplist_merge, i, variant_base)
        l2 = calculate_joint_genotype_tumor_fraction_loglikelihood(0.0, basestring_normal, quallist_normal, maplist_normal, i, variant_base)
        loglikelihood_dict[i] =  l1 + l2
